		...
		<div class="page-container2">
			...
			<div class="card">
				<div class="card-header">
					<a href="<?php echo base_url('user/repositori');?>">
				...
				<div class="card-body card-block">
					<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="row form-group">
							<div class="col col-md-3">
								<a href="<?php echo base_url('user/repositori/edit/'.$berkas->ID_BERKAS)?>">
									<button type="submit" name="ubah" class="btn btn-warning btn-sm">
										Ubah
									</button></a>
								<a onclick="deleteConfirm('<?php echo base_url('user/repositori/del/'.$berkas->ID_BERKAS) ?>')" href="#!"
			...
			<div class="user-data m-b-40">
				<h4 class="title-3 m-b-30">
					...
					<a href="<?php echo base_url('user/file/add/').$berkas->ID_BERKAS;?>" class="pull-right">
					...
					<table class="table table-borderless table-striped table-earning" id="datatable">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="<?php echo base_url('user/repositori/file/').$row->ID_UPLOAD?>" color="black">
								...
								<td>
									<a href="<?php echo base_url('user/file/download/'.$row->ID_UPLOAD)?>" class="btn btn-primary btn-sm">
										Download
									</a>
									<a href="<?php echo base_url('user/file/edit/'.$row->ID_UPLOAD)?>">
										<button type="submit" name="ubah" class="btn btn-warning btn-sm">
											Ubah
										</button></a>
									<a onclick="deleteConfirm('<?php echo base_url('user/file/del/'.$row->ID_UPLOAD) ?>')" href="#!" class="btn btn-danger btn-sm">
										Hapus
									</a>
								</td>
							</tr>
