					...
					<table class="table table-borderless table-striped table-earning" id="datatable">
						...
						<tbody>
							...
							<tr>
								...
								<td>
								<a href="<?php echo base_url('user/repositori/view/'.$row->ID_BERKAS)?>">
								...
								<td>
									<a href="<?php echo base_url('user/repositori/edit/'.$row->ID_BERKAS)?>">
										<button type="submit" name="ubah" class="btn btn-warning btn-sm">
											Ubah
										</button></a>
									<a onclick="deleteConfirm('<?php echo base_url('user/repositori/del/'.$row->ID_BERKAS) ?>')" href="#!" class="btn btn-danger btn-sm">
										Hapus
									</a>
								</td>
							</tr>
