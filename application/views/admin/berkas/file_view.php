			...
			<div class="card">
				...
				<div class="card-body card-block">
					<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="row form-group">
							<div class="col col-md-3">
								<a href="<?php echo base_url('file/download/'.$file->ID_UPLOAD)?>" class="btn btn-primary btn-sm">
									Download
								</a>
								<a onclick="deleteConfirm('<?php echo base_url('file/del/'.$file->ID_UPLOAD) ?>')" href="#!"
