	...
	<main>
		...
		<div class="card">
			<div class="card-header">
				<a href="<?php echo base_url('mahasiswa/prodi/'.$dosen->ID_PRODI);?>">
			...
			<div class="card-body card-block">
				<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
						<div class="col col-md-3">
							<label for="number" class=" form-control-label">Nama Dosen</label>
						</div>
						<div class="col-12 col-md-9">
					...
					<div class="row form-group">
						<div class="col col-md-3">
							<label for="select" class=" form-control-label">No. Telp</label>
						</div>
						<div class="col-12 col-md-9">
		...
		<div class="user-data m-b-40">
			<h3 class="title-3 m-b-30">
				<i class="zmdi zmdi-account"></i>Berkas</h3>
				...
				<table class="table table-borderless table-striped table-earning" id="datatable">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?php echo base_url('mahasiswa/file/').$row->ID_BERKAS?>" color="black">
