...
class Repositori extends CI_Controller
{
    ...
    {
        $data["berkas"] = $this->berkas_model->getByIdDosen($this->session->userdata('ses_id'));
        $this->load->model('kategori_model');
        $this->load->model('dosen_model');
        $this->load->view("admin/repository/berkas", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("admin/repository/berkas_form", $data);
    }
