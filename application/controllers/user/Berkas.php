...
class Berkas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("user/berkas/berkas", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("user/berkas/berkas_form", $data);
    }
    ...
    public function view($id = null)
    {
        ...
        $this->load->view("user/berkas/berkas_view", $data);
    }

    public function file($id = null)
    {
        if (!isset($id)) redirect('user/berkas');
        ...
        $this->load->view("user/berkas/file_view", $data);
    }
